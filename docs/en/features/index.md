...
Since v1.1, sip moves from "information warehouse" toward "information ingestion management system": read → analyze → you confirm → rule takes effect → the feed gets cleaner. Four "decision is yours" capabilities — **detection is a fact, the decision is yours, the rule persists**:
